...
## 1. U-Net을 처음 알게 되었고, 그 구조를 이해하면서 든 질문들
...
여러 개의 U-Net을 합쳐서 더 정밀한 모델을 만들 수도 있지 않을까? 라는 생각을 하게 되었습니다.

## 5. 픽셀 단위 vs 객체 단위 분류, 이걸 다 합칠 수도 있을까?
